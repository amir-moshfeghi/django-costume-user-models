"""
Django settings for costumeUserModels project.
...
SECRET_KEY = '^k_@^t_ypw+=z0)b5t$m6il26$yr+txpsl385%uj1w)1i@55l%'
...
ROOT_URLCONF = 'costumeUserModels.urls'
...
WSGI_APPLICATION = 'costumeUserModels.wsgi.application'
